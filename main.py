    ...
    if event.chat.id == GROUP_ID and event.new_chat_member.user.id == YANA_ID:
        await bot.send_message(
            ...
            text=(
                ...
                f"(пишу тебе через код, бот автоматически отправит это тебе когда ты зайдешь в группу, "
                f"эта группа это замена нашего лс, но только с добавлениеи этого бота ахах)
            ),
            parse_mode="HTML"
        )
